...
[Types]
Name: "full-python2";               Description: "Full installation Python 2(build-tools, engine, dependencies, demos, tools)"
Name: "full-python3";               Description: "Full installation Python 3(build-tools, engine, dependencies, demos, tools)"
Name: "build-tools-python2";        Description: "Build-tools only (CMake, Python2, Boost, Swig)"
Name: "build-tools-python3";        Description: "Build-tools only (CMake, Python3, Boost, Swig)"
Name: "fife-only-python2";          Description: "Engine only Python2 Version"
Name: "fife-only-python3";          Description: "Engine only Python3 Version"
...
[Components]
Name: fifengine-py2;                Description: "[fifengine] Fifengine - Isometric Game Engine";    Types: full-python2 fife-only-python2
Name: fifengine-py3;                Description: "[fifengine] Fifengine - Isometric Game Engine";    Types: full-python3 fife-only-python3
...
Type: filesandordirs; Name: "{app}\python34"
...
begin
  ...
  begin
    ...
    RemovePathLocalUser(ExpandConstant('{app}') + '\python34\Lib\site-packages\fife');
    RemovePathLocalUser(ExpandConstant('{app}') + '\python34');
